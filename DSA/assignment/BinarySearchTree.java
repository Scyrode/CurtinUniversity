...
public class BinarySearchTree<E> implements Serializable {
    ...
    public void inOrderTrav(DSAQueue<E> queue) { inOrderRec(this.m_root, queue); }
    
    private void inOrderRec(TreeNode<E> curr, DSAQueue<E> queue) {

	if (curr != null) {

	    inOrderRec(curr.getLeft(), queue);

	    queue.enqueue(curr.getValue());
    ...
    public void preOrderTrav(DSAQueue<E> queue) { preOrderRec(this.m_root, queue); }
	
    private void preOrderRec(TreeNode<E> curr, DSAQueue<E> queue) {
    ...
    public void postOrderTrav(DSAQueue<E> queue) { postOrderRec(this.m_root, queue); }
	
    private void postOrderRec(TreeNode<E> curr, DSAQueue<E> queue) {
